...
def load_table(file_path, table_name):
    path = f"{file_path}/{table_name}.csv"
...
# ===== BAR =====
def plot_bar(file_path, table_name, section, x, y, title, xlabel="", ylabel="", top_n=20):
...
# ===== TREND =====
def plot_trend(file_path, table_name, section, title, xlabel="", ylabel=""):
    df = load_table(file_path, table_name)
...
# ===== SCATTER =====
def plot_scatter(file_path, table_name, section, x, y, title, xlabel="", ylabel=""):
    df = load_table(file_path, table_name)
...
# ===== BUBBLE =====
def plot_bubble(file_path, table_name, section, x, y, size, title, xlabel="", ylabel=""):
    df = load_table(file_path, table_name)
...
def plot_bar_line(file_path, table_name, section, x, bar_values, line_values, title,
